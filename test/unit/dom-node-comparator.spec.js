describe('module: DOMNode-Comparator', function () {
	describe('method: nodeName', function () {
		it('compares how closely doms are related', function () {
			...
			nodeA: VWO.DOMNode.create({el:$('<div class="chapter 1">   <div class="prev"><a class="chapter" href="/default.asp" style=color:blue>W3Schools Home</a></div>       <h2>Tutorial</h2>          <h3> Hello </h3>         </div>').get(0)}), 
			nodeB: VWO.DOMNode.create({el:$('<div class="chapter">   <h2>Tutorial311</h2>    <div class="prev"><a class="chapter12" href="/default.asp" style=color:red>W3Schools Home</a></div>       <h2>Tutorial</h2>   </div>').get(0)})
			});
			...
			expect(domNode.changedAttributes()).toEqual({class : 'chapter'}) ;  
